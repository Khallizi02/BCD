...
DROP VIEW vw_aniversariantes_mes2;

CREATE VIEW vw_aniversariantes_por_mes AS
SELECT
      nome_cliente,
	  telefone_cliente,
...
FROM vw_aniversariantes_por_mes;
...
CREATE VIEW vw_clientes_nascimento2 AS
SELECT 
	  nome_cliente, 
...
CREATE VIEW vw_produtos_precos2 AS
SELECT
      nome_produto,
      preco_venda - preco_compra AS lucro
FROM tb_produto;

SELECT * FROM vw_produtos_precos2;
